  ...
  return (
    <ContentPage title="Careers" description="Join our team">
      <div className="space-y-6 text-neutral-600">
        <p>
          We&apos;re building the future of beauty and wellness booking. If you&apos;re passionate
          about great products and helping people look and feel their best, we&apos;d love to hear from you.
        </p>
